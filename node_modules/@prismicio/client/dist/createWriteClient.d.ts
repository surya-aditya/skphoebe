...
export interface CreateWriteClient {
    <TDocuments extends PrismicDocument>(...args: ConstructorParameters<typeof WriteClient>): WriteClient<TDocuments>;
}
/**
 ...
 */
export declare const createWriteClient: CreateWriteClient;
